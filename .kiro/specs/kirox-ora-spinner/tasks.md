...
- [ ] 3. reportProgress メソッドをスピナーベースに移行
- [ ] 3.1 シングルプロジェクトモードのスピナー進捗表示を実装
